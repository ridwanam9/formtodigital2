                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    name="kegawatanpernafasan[]" id="dyspnoe" value="dyspnoe"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    name="kegawatanpernafasan[]" id="adasekret" value="adasekret"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    name="kegawatanpernafasan[]" id="spo2-normal" value="spo2normal"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    name="kegawatanpernafasan[]" id="nafaslambat" value="nafaslambat"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    name="kegawatanpernafasan[]" id="takkegawatan" value="tak"
